...
const TermsAndConditions = () => {
    return (
        <section className='w-[95%] m-auto max-w-[1300px] pb-[50px]'>
            ...
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - These Terms apply to all users, including <b>visitors, customers, and businesses</b> purchasing from our website. <br />
                - We reserve the right to update, modify, or remove any part of these Terms at our discretion. <br />
            ...
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - All products listed on our website are subject to <b>availability</b>. We do not guarantee that a product will always be in stock. <br />
                - Product descriptions, specifications, and images are provided for reference only. While we strive for accuracy, slight variations may occur. <br />
                - We reserve the right to <b>discontinue or modify</b> any product without prior notice.
            </p>
            ...
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - Placing an order on our website constitutes an <b>offer to purchase</b>. We reserve the right to accept or decline any order. <br />
                - An order is confirmed only after full payment is received. <br />
            ...
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - Prices displayed on our website are in <b>PKR</b> and are subject to change without notice. <br />
                - We accept various <b>secure payment methods</b>, including credit/debit cards, bank transfers, and digital payment gateways. <br />
                - <b>Taxes, shipping fees, and additional charges</b> (if applicable) will be displayed at checkout. <br />
                - If a payment is declined or fraudulent, we reserve the right to <b>cancel the order</b>.
            </p>

            <h2 className='text-[#00605f] playfair font-bold text-[25px] md:text-[35px] tracking-[1.5px] mt-[20px]'>4. Shipping and Delivery</h2>
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - We aim to process and ship orders within <b>3 - 5 business days</b>, but delivery times may vary based on location. <br />
                - Delays due to external factors (e.g., customs, courier issues, natural disasters) are <b>beyond our control</b>, and we are not liable for late deliveries. <br />
                - Customers must provide <b>accurate shipping details</b>. We are not responsible for non-delivery due to incorrect information. <br />
            ...
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - Returns are accepted within <b>2 days</b> of delivery, provided the item is <b>unused, undamaged, and in original packaging</b>. (Returns are not applicable for all items). <br />
                - Some products, such as sterile medical supplies or personalized items, are <b>non-returnable</b> for safety reasons.
            </p>

            <h3 className='text-[#00605f] playfair font-bold text-[20px] md:text-[25px] tracking-[1.5px] mt-[15px]'>5.2 Refund Policy</h3>
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - Refunds will be processed once the returned item is inspected and approved. <br />
                - Refunds are issued via the original payment method and may take <b>2 business days</b> to reflect. <br />
                - <b>Shipping fees are non-refundable</b> unless the return is due to our error.
            </p>

            <h3 className='text-[#00605f] playfair font-bold text-[20px] md:text-[25px] tracking-[1.5px] mt-[15px]'>5.3 Order Cancellations</h3>
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - Orders can only be canceled before they are shipped. Once dispatched, cancellations are <b>not possible</b>. <br />
                - If an order is canceled before shipment, a <b>full refund</b> will be issued.
            </p>

            <h2 className='text-[#00605f] playfair font-bold text-[25px] md:text-[35px] tracking-[1.5px] mt-[20px]'>6. Warranty and Liability</h2>
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - <b>Biova Surgicals</b> guarantees that all products meet <b>quality and safety standards</b>. <br />
                - We are not liable for <b>misuse, improper handling, or modifications</b> made to our products after purchase. <br />
                - Customers must follow the <b>manufacturer's guidelines</b> for product use. <br />
                - In no event shall <b>Biova Surgicals</b> be responsible for any <b>indirect, incidental, or consequential damages</b> arising from product use.
            </p>

            <h2 className='text-[#00605f] playfair font-bold text-[25px] md:text-[35px] tracking-[1.5px] mt-[20px]'>7. Intellectual Property</h2>
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - All content on our website, including <b>logos, product descriptions, images, and graphics</b>, is the <b>intellectual property of Biova Surgicals</b>. <br />
            ...
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - We collect, store, and process personal information as outlined in our <Link to="/privacy-policy" className="text-[#00605f] underline">Privacy Policy</Link>. <br />
                - Customer data is used only for order processing, customer service, and website improvements. <br />
            ...
            <p className='text-[#00807b] lato text-[17px] md:text-[20px] mb-[20px]'>
                - In the event of a dispute, we encourage customers to <b>first contact us</b> to resolve the issue amicably. <br />
                - If a resolution cannot be reached, disputes shall be handled under the laws of <b>PAKSITAN/KARCHI</b>. <br />
